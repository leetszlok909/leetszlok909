...
if($signup)
{
	echo  '<p class="login">'."You register successfully .<br> Welcome to join this system. <br> Enjoy." .'</p>'  ;
	echo  '<p class="login">' . "Thany you for your register." . '</p>';
	 echo '<p class="login">' ."Back to home page in 3 secconds". '</p>';	 
...
{
	echo  '<p class="login">'."Sorry,your username or email has been used. Please use other ". '</p>' ;
	
	 echo '<p class="login">' ."Back to signup page in 3 secconds". '</p>';
